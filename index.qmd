...
## Data Science Ethics Collated Syllabi

The table below details the syllabi that we used to examine data science ethics curriculum. A majority of them are undergraduate courses and include a reading list on the syllabi. Visit [Inside the Syllabi Notes](inside-syllabi.html) for in-depth notes on each course's learning goals and topics.
:::
